...
class StartMenu(widget.Widget):
    def __init__(self, game: main.Game):
        super().__init__(game)
        self.start_button = ActionButton(self, (400, 100), 'buttons/not_current_play_button.png',
                                         'buttons/not_current_play_button.png', self.action_buttons)
        self.exit_button = ActionButton(self, (400, 400), 'buttons/not_current_exit_button.png',
                                        'buttons/not_current_exit_button.png', self.action_buttons)
